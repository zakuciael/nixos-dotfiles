...
# Copied from: https://github.com/NixOS/nixpkgs/blob/6d8ddd87dc098ac9fb0468a80d2d94c400c5f856/pkgs/applications/editors/jetbrains/plugins/update_plugins.py
# All credits go to the nixpkgs maintainers
...
def get_ide_versions() -> dict:
    # Modified get_ide_versions() method that uses nix eval to get build numbers for IDEs
    ...
    res = run(cmd, cwd = None, check=True, text=True, stdout=PIPE) # capture_output=True
    result = loads(res.stdout)
